...
export default () => {
    ...
    return (
        <>
            ...
            {/* Edit Profile Modal */}
            <div id="spendwise-edit-profile" tabIndex="-1" aria-hidden="true" className="bg-gray-400 bg-opacity-50 hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 max-h-full">
