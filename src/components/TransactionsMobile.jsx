                    ...
                    <Dialog open={true} onClose={closeTransactionModal} className="fixed inset-0 z-50">
                        ...
                        >
                            ...
                            <div className="space-y-2 text-sm text-gray-700">
                                ...
                                <p><strong>Receiver:</strong> {selectedTxn.name}</p>
                                <p><strong>Date/Time:</strong> {formatDateTime(selectedTxn.date)}</p>
                                <p><strong>UPI ID:</strong> {selectedTxn.upi_id || 'N/A'}</p>
                                <p><strong>Txn ID:</strong> {selectedTxn.transaction_id || 'N/A'}</p>
                                <p><strong>Category:</strong> {selectedTxn.expense_type || 'N/A'}</p>
                            </div>
                            <button
